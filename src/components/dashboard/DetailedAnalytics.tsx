                ...
                <AccordionItem value="creator">
                    <AccordionTrigger className="text-base font-semibold hover:no-underline">
                        <div className="flex items-center gap-2">
                            <User className="h-5 w-5 text-primary" /> Creator Details
                        </div>
                    </AccordionTrigger>
                    <AccordionContent>
                        <div className="mb-4 space-y-2 text-sm px-4">
                            <div><strong>Creator Fingerprint Hash:</strong> <code className="text-xs bg-muted p-1 rounded break-all">{link.creatorFingerprint}</code></div>
                        </div>
                        <FingerprintDetail data={link.creatorFingerprintData} />
                    </AccordionContent>
                </AccordionItem>
